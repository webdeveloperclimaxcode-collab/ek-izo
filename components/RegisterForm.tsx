      ...
      <div className="max-w-md w-full">
        ...
        <div className="bg-white dark:bg-[#000000] rounded-[24px] shadow-xl dark:shadow-2xl p-8 border border-gray-100 dark:border-gray-700 transition-colors duration-300">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            {/* Full Name Field */}
            <div>
              <label htmlFor="fullName" className="block text-[14px] font-semibold text-[#1B2556] dark:text-white mb-2 transition-colors">
                Full Name
              </label>
              <input
                id="fullName"
            ...
            <div>
              <label htmlFor="confirmPassword" className="block text-[14px] font-semibold text-[#1B2556] dark:text-white mb-2 transition-colors">
                Confirm Password
              </label>
              <div className="relative">
                <input
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-[13px]">
              <span className="px-4 bg-white dark:bg-[#000000] text-[#64748B] dark:text-gray-400 transition-colors">Or sign up with</span>
            </div>
          </div>
