  ...
  return (
    <section className={`w-full py-16 transition-colors duration-300 ${theme === "dark" ? "bg-[#000000]" : "bg-white"}`}>
      <div className="w-full px-6 lg:px-12 xl:px-16 2xl:px-20 max-w-[1400px] mx-auto">
        <div className={`rounded-[20px] sm:rounded-[32px] px-6 sm:px-10 py-8 sm:py-10 flex flex-col md:flex-row items-center justify-between gap-6 md:gap-8 border shadow-sm transition-colors duration-300 ${theme === "dark"
          ...
          <div className="flex items-center gap-4 sm:gap-6 w-full md:w-auto">
            ...
            <div className="flex-1">
              <h3 className={`text-[20px] sm:text-[24px] lg:text-[28px] font-bold mb-2 tracking-wide transition-colors duration-300 ${theme === "dark" ? "text-white" : "text-gray-800"
                }`}>
                {t("costOfServices.heading")}
              </h3>
              <p className={`text-[14px] sm:text-[16px] lg:text-[17px] leading-relaxed transition-colors duration-300 ${theme === "dark" ? "text-gray-300" : "text-gray-600"
                }`}>
