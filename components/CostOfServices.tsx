  ...
  return (
    <section className={`w-full py-12 transition-colors duration-300  bg-[#292929]`}>
      <div className="w-full px-6 lg:px-12 xl:px-16 2xl:px-20 max-w-full mx-auto">
        <div className={`  py-8 sm:py-10 flex flex-col md:flex-row items-center justify-between gap-6 md:gap-8  transition-colors duration-300 `}>
          <div className="flex items-center gap-4 sm:gap-6 w-full md:w-auto">
            ...
            <div className="flex-1">
              ...
              <p className={`text-[14px] lg:text-[30px] sm:text-[16px] leading-relaxed transition-colors duration-300 ${theme === "dark" ? "text-gray-300" : "text-[#B1B1B1]"
                }`}>
