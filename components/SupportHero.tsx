    ...
    <div>
      ...
      <section className={`w-full py-16 transition-colors duration-300 ${theme === "dark" ? "bg-[#000000]" : "bg-white"}`}>
        <div className="w-full px-6 2xl:px-20 max-w-5xl mx-auto">
          {/* Title */}
          <h2 className={`text-[32px] text-center mb-6 transition-colors duration-300 ${theme === "dark" ? "text-white" : "text-[#4A5568]"}`}>
            Our{" "}
            <span className={`font-bold transition-colors duration-300 ${theme === "dark" ? "text-white" : "text-[#1B2556]"}`}>
          ...
          {/* Description */}
          <p className={`text-[15px] leading-relaxed text-center mb-10 max-w-4xl mx-auto transition-colors duration-300 ${theme === "dark" ? "text-white" : "text-[#1B2556]"}`}>
            <span className="text-[#9F001B] font-semibold">IZOGRUP</span>{" "}
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-6">
            <Link
              href="#contact-form"
              className="px-10 py-4 bg-linear-to-r from-[#9F001B] to-[#1B2556] text-white font-semibold rounded-full hover:opacity-90 transition-opacity text-[15px] min-w-[280px] text-center"
            >
              CONTACT US ONLINE
            </Link>
            <Link
