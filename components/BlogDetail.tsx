    ...
    <section className={`w-full py-12 transition-colors duration-300 ${theme === "dark" ? "bg-[#000000]" : "bg-white"}`}>
      <div className="w-full px-6 lg:px-12 xl:px-16 2xl:px-20  mx-auto">
        ...
        <div className="mb-8">
          {/* Category */}
          {blog.category && (
            <span className="inline-block px-4 py-2 lg:text-base bg-brand-secondary text-white text-[12px] font-semibold uppercase tracking-wider rounded-full mb-4">
              {blog.category.name}
            </span>
          )}
          ...
          {/* Meta Info */}
          <div className={`flex flex-wrap items-center lg:text-base gap-4 text-[14px] transition-colors duration-300 ${theme === "dark" ? "text-gray-400" : "text-[#6B7280]"}`}>
        ...
        <div className="prose prose-lg max-w-none mb-8">
          <div
            className={`text-[16px] lg:text-xl leading-relaxed whitespace-pre-line transition-colors duration-300 ${theme === "dark" ? "text-gray-300" : "text-[#4A5568]"}`}
